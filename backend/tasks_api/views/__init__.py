from .tasks import task_list as task_list, task_detail as task_detail, task_reorder as task_reorder, my_tasks as my_tasks, task_duplicate as task_duplicate, task_history as task_history
...
from .attachments import attachment_list as attachment_list, attachment_detail as attachment_detail, attachment_download as attachment_download, attachment_thumbnail as attachment_thumbnail
