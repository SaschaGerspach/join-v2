from .tasks import task_list as task_list, task_detail as task_detail, task_reorder as task_reorder, my_tasks as my_tasks, task_duplicate as task_duplicate
